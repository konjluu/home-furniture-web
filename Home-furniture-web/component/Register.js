...
class Register {
  ...
  constructor() {
    ...
    this.$mainContainer.style.backgroundImage = "url('https://nt11.mediawz.com/wp-content/uploads/2017/10/slider-lan-anh-villa.jpg')";
    this.$mainContainer.setAttribute("class", "w-screen h-screen pt-24");

    this.$formEl = document.createElement("form");
    this.$formEl.setAttribute(
      "class",
      "w-1/3 bg-gray-400 py-12 px-4 mx-auto rounded-xl bg-opacity-50"
    );
    ...
    this.$goToLoginPage.setAttribute("class", "text-white font-bold mt-2 cursor-pointer");
